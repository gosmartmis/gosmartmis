import{r as c,s as q}from"./index-KD-SY-um.js";const v=m=>{const{schoolId:u,classId:_,subjectId:h,termId:g,teacherId:l,studentId:p,status:i}=m,[E,r]=c.useState([]),[b,f]=c.useState(!0),[o,w]=c.useState(null),S=async()=>{if(!u){f(!1);return}try{f(!0),w(null);let e=q.from("marks").select(`
          *,
          students:student_id (
            full_name
          ),
...
//# sourceMappingURL=useMarks-BRdT2lm8.js.map
