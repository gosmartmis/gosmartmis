import{r as t,s as E}from"./index-DCgxXzl4.js";const g=(s,a)=>{const[l,f]=t.useState([]),[i,r]=t.useState(!0),[d,n]=t.useState(null),o=async()=>{if(!s){r(!1);return}try{r(!0),n(null);let e=E.from("students").select(`
          *,
          classes:class_id (
            name
          )
...
//# sourceMappingURL=useStudents-BnJfwQTW.js.map
