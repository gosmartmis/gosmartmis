import{r,s as y}from"./index-KD-SY-um.js";const E=["Monday","Tuesday","Wednesday","Thursday","Friday"],q=(u,s)=>{const[o,n]=r.useState(null),[b,c]=r.useState(!0),[h,d]=r.useState(null),m=async()=>{if(!u||!s){c(!1);return}try{c(!0),d(null);const{data:a,error:f}=await y.from("timetables").select(`
          id,
          day_of_week,
          period_number,
          start_time,
...
//# sourceMappingURL=useHolidayPackages-CDOyP0v4.js.map
