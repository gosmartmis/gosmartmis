...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'my-classes',       label: 'My Classes',         icon: 'ri-book-open-line'    },
  { id: 'marks-entry',      label: 'Marks Entry',        icon: 'ri-pencil-line'       },
  { id: 'marks-approval',   label: 'Marks Status',       icon: 'ri-checkbox-multiple-line' },
  { id: 'attendance',       label: 'Attendance',         icon: 'ri-user-follow-line'  },
  { id: 'timetable',        label: 'Timetable',          icon: 'ri-calendar-line'     },
  { id: 'holiday-packages', label: 'Holiday Packages',   icon: 'ri-gift-line'         },
